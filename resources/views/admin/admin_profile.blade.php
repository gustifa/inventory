                        ...
                        <div class="align-items-center">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="overflow-hidden ms-4">
                                    ...
                                    <span class="fs-15"><i class="align-middle mdi mdi-message me-2"></i>Speaks: <span>English <span class="px-2 py-1 badge bg-primary-subtle text-primary fs-13 fw-normal">native</span> , Spanish, Turkish </span></span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="align-items-center">
                            <div class="d-flex align-items-center">
                                <img src="{{asset ('backend/assets/images/users/user-11.jpg')}}" class="rounded-circle avatar-xxl img-thumbnail float-start" alt="image profile">

                                <div class="overflow-hidden ms-4">
                                    <h4 class="m-0 text-dark fs-20">{{$profileData->name}}</h4>
                                    <p class="my-1 text-muted fs-16">Passionate Software Engineer Crafting Innovative Solutions</p>
                                    <span class="fs-15"><i class="align-middle mdi mdi-message me-2"></i>Speaks: <span>English <span class="px-2 py-1 badge bg-primary-subtle text-primary fs-13 fw-normal">native</span> , Bitish, Turkish </span></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <ul class="pt-2 nav nav-underline border-bottom" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="p-2 nav-link" id="profile_experience_tab" data-bs-toggle="tab" href="#profile_experience" role="tab">
                                    <span class="d-block d-sm-none"><i class="mdi mdi-sitemap-outline"></i></span>
                                    <span class="d-none d-sm-block">Work experience</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="p-2 nav-link" id="portfolio_education_tab" data-bs-toggle="tab" href="#profile_education" role="tab">
                                    <span class="d-block d-sm-none"><i class="mdi mdi-school"></i></span>
                                    <span class="d-none d-sm-block">Education</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="p-2 nav-link" id="setting_tab" data-bs-toggle="tab" href="#profile_setting" role="tab">
                                    <span class="d-block d-sm-none"><i class="mdi mdi-school"></i></span>
                        ...
                        <div class="bg-white tab-content text-muted">
                            <div class="pt-4 tab-pane active show" id="profile_about" role="tabpanel">
                                <div class="row">
                                    <div class="mb-4 col-md-6 col-sm-6">
                                        <div class="">
                                            <h5 class="mb-3 fs-16 text-dark fw-semibold text-capitalize">About me</h5>
                                        ...
                                        <div class="mt-3 skills-details">
                                            <h6 class="text-uppercase fs-13">Skills</h6>

                                            <div class="flex-wrap gap-2 d-flex">
                                                <span class="px-3 py-2 badge bg-light text-dark fw-semibold">User Interface</span>
                                                <span class="px-3 py-2 badge bg-light text-dark fw-semibold">User Experience</span>
                                                <span class="px-3 py-2 badge bg-light text-dark fw-semibold">Interaction Design </span>
                                                <span class="px-3 py-2 badge bg-light text-dark fw-semibold">3D Design</span>
                                                <span class="px-3 py-2 badge bg-light text-dark fw-semibold">Information Architecture</span>
                                                <span class="px-3 py-2 badge bg-light text-dark fw-semibold">User Research</span>
                                                <span class="px-3 py-2 badge bg-light text-dark fw-semibold">Wireframing</span>
                                            </div>
                                    ...
                                    <div class="mb-4 col-md-6 col-sm-6">
                                        <h5 class="mb-3 fs-16 text-dark fw-semibold text-capitalize">Contact Details</h5>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-lg-4">
                                                <div class="profile-email">
                                                    ...
                                                    <ul class="mt-0 mb-0 social-list list-inline">
                                        ...
                                        <div class="mt-3 skills-details">
                                            ...
                                            <div class="flex-wrap gap-2 d-flex">
                                                <span class="px-3 py-2 badge bg-light text-dark fw-semibold">English</span>
                                                <span class="px-3 py-2 badge bg-light text-dark fw-semibold">Madrian</span>
                                                <span class="px-3 py-2 badge bg-light text-dark fw-semibold">Spanish</span>
                                                <span class="px-3 py-2 badge bg-light text-dark fw-semibold">French</span>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="mb-0 col-md-6 col-sm-6">
                                        <div class="">
                                            <h5 class="mb-3 fs-16 text-dark fw-semibold text-capitalize">Projects</h5>
                                        </div>
                                                ...
                                                <div class="border card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="mt-2 row d-flex align-items-center">
                                                            <div class="col">
                                                                <h5 class="mt-1 fs-20 fw-bold">$12,000</h5>
                                                                <p class="mb-0 text-muted">Total Budget</p>
                                                            </div>
                                                            <div class="col-auto">
                                                                <a href="#" class="px-3 btn btn-sm btn-outline-dark">More Details</a>
                                                            </div>
                                                        </div>
                                                    </div><!--end card-body-->
                                                </div>
                                            ...
                                            <div class="col-6">
                                                <div class="border card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="mt-2 row d-flex align-items-center">
                                                            <div class="col">
                                                                <h5 class="mt-1 fs-20 fw-bold">$35,800</h5>
                                                                <p class="mb-0 text-muted">Total Budget</p>
                                                            </div>
                                                            <div class="col-auto">
                                                                <a href="#" class="px-3 btn btn-sm btn-outline-dark">More Details</a>
                                            ...
                                            <div class="col-6">
                                                <div class="mb-0 border card">
                                                    <div class="card-body ">
                                                        ...
                                                        <div class="mt-2 row d-flex align-items-center">
                                                            <div class="col">
                                                                <h5 class="mt-1 fs-20 fw-bold">$8,000</h5>
                                                                <p class="mb-0 text-muted">Total Budget</p>
                                                            </div>
                                                            <div class="col-auto">
                                                                <a href="#" class="px-3 btn btn-sm btn-outline-dark">More Details</a>
                                            ...
                                            <div class="col-6">
                                                <div class="mb-0 border card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="mt-2 row d-flex align-items-center">
                                                            <div class="col">
                                                                <h5 class="mt-1 fs-20 fw-bold">$16,000</h5>
                                                                <p class="mb-0 text-muted">Total Budget</p>
                                                            </div>
                                    ...
                                    <div class="mb-0 col-md-6 col-sm-6">
                                        <div class="">
                                            <h5 class="mb-3 fs-16 text-dark fw-semibold text-capitalize">Expertise</h5>
                                        </div>

                                        <div class="row align-items-center g-0">
                                            <div class="col-sm-3">
                                                <p class="mt-1 mb-0 text-truncate"><i class="mdi mdi-circle-medium text-primary me-2"></i> Photoshop </p>
                                            </div>

                                            <div class="col-sm-9">
                                                <div class="mt-1 progress" style="height: 8px;">
                                                    <div class="rounded progress-bar bg-primary" role="progressbar" style="width: 72%" aria-valuenow="52" aria-valuemin="0" aria-valuemax="52">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

                                        <div class="mt-3 row align-items-center g-0">
                                            <div class="col-sm-3">
                                                <p class="mt-1 mb-0 text-truncate"><i class="mdi mdi-circle-medium text-primary me-2"></i> illustrator </p>
                                            </div>
                                            <div class="col-sm-9">
                                                <div class="mt-1 progress" style="height: 8px;">
                                                    <div class="rounded progress-bar bg-primary" role="progressbar" style="width: 45%" aria-valuenow="45" aria-valuemin="0" aria-valuemax="45">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mt-3 row align-items-center g-0">
                                            <div class="col-sm-3">
                                                <p class="mt-1 mb-0 text-truncate"><i class="mdi mdi-circle-medium text-primary me-2"></i> HTML </p>
                                            </div>
                                            <div class="col-sm-9">
                                                <div class="mt-1 progress" style="height: 8px;">
                                                    <div class="rounded progress-bar bg-primary" role="progressbar" style="width: 68%" aria-valuenow="48" aria-valuemin="0" aria-valuemax="48">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mt-3 row align-items-center g-0">
                                            <div class="col-sm-3">
                                                <p class="mt-1 mb-0 text-truncate"><i class="mdi mdi-circle-medium text-primary me-2"></i> CSS </p>
                                            </div>
                                            <div class="col-sm-9">
                                                <div class="mt-1 progress" style="height: 8px;">
                                                    <div class="rounded progress-bar bg-primary" role="progressbar" style="width: 78%" aria-valuenow="78" aria-valuemin="0" aria-valuemax="78">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mt-3 row align-items-center g-0">
                                            <div class="col-sm-3">
                                                <p class="mt-1 mb-0 text-truncate"><i class="mdi mdi-circle-medium text-primary me-2"></i> Javascript </p>
                                            </div>
                                            <div class="col-sm-9">
                                                <div class="mt-1 progress" style="height: 8px;">
                                                    <div class="rounded progress-bar bg-primary" role="progressbar" style="width: 63%" aria-valuenow="63" aria-valuemin="0" aria-valuemax="63">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mt-3 row align-items-center g-0">
                                            <div class="col-sm-3">
                                                <p class="mt-1 mb-0 text-truncate"><i class="mdi mdi-circle-medium text-primary me-2"></i> Php </p>
                                            </div>
                                            <div class="col-sm-9">
                                                <div class="mt-1 progress" style="height: 8px;">
                                                    <div class="rounded progress-bar bg-primary" role="progressbar" style="width: 48%" aria-valuenow="48" aria-valuemin="0" aria-valuemax="48">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="pt-4 tab-pane" id="profile_experience" role="tabpanel">
                                <div class="row">

                                    <div class="col-md-12 col-sm-12 col-lg-6">
                                        <h5 class="mb-3 fs-16 text-dark fw-semibold text-capitalize">Experience</h5>
                                    </div>

                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-lg-6">
                                            <ol class="px-4 mb-0 profile-section list-unstyled">
                                                <li class="profile-item">
                                                    <div class="p-1 avatar-sm profile-icon">
                                                ...
                                                <li class="profile-item">
                                                    ...
                                                    <div class="exper-item-list">
                                                        <div>
                                                            <h5 class="mb-1 font-size-16">VP, Product Management</h5>
                                                            <div class="mb-1 list-inline list-inline-dots fs-14">
                                                ...
                                                <li class="pb-0 profile-item">
                                                    ...
                                                    <div class="exper-item-list">
                                                        <h5 class="mb-1 font-size-16">Director, Product Management</h5>
                                                        <div class="mb-1 list-inline list-inline-dots fs-14">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-lg-6">
                                            <ol class="px-4 mb-0 profile-section list-unstyled">
                                                ...
                                                <li class="profile-item">
                                                    ...
                                                    <div class="exper-item-list">
                                                        <h5 class="mb-1 font-size-16">Mobile Developer & Algo Expert</h5>
                                                        <div class="mb-1 list-inline list-inline-dots fs-14">
                                                ...
                                                <li class="pb-0 profile-item">
                                                    ...
                                                    <div class="exper-item-list">
                                                        <h5 class="mb-1 font-size-16">UI /UX Designer</h5>
                                                        <div class="mb-1 list-inline list-inline-dots fs-14">
                            ...
                            <div class="pt-4 tab-pane" id="profile_education" role="tabpanel">
                                <div class="row">

                                    <div class="col-md-12 col-sm-12 col-lg-6">
                                        <h5 class="mb-3 fs-16 text-dark fw-semibold text-capitalize">My Education</h5>
                                    </div>
                            ...
                            <div class="pt-4 tab-pane" id="profile_setting" role="tabpanel">
                                <div class="row">
